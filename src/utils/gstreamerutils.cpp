...
using namespace GstreamerStudio::Utils;
using namespace Gst;
using Glib::RefPtr;

std::map<std::string, ObjectNodeInfo> GstreamerUtils::get_object_info(const Glib::RefPtr<Gst::Object>& object)
{
  ...
  // else if (RefPtr<Link>::cast_static(object)) todo
...
ObjectNodeInfo GstreamerUtils::parse_caps(const RefPtr<Caps>& caps)
{
...
ObjectNodeInfo::MapInfo GstreamerUtils::parse_pad_template(const RefPtr<PadTemplate>& tpl)
{
