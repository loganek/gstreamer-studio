...
GstreamerController::GstreamerController(const RefPtr<Pipeline>& master_model)
...
void GstreamerController::set_watch_method(const RefPtr<Element>& element)
{
...
void GstreamerController::add_sometimes_pad(const RefPtr<Pad>& pad)
{
